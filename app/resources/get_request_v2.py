...
class getRequestV2(Resource): # create a class named getRequestV2 that inherits from the Resource class
    ...
    def get(self): # create a get method
        return 'Version2 hello world' # return the string 'Version2 hello world'
    ...
    def post(self): # create a post method
        ...
        try: # try block
            ...
            return f'Hello {data["name"]}! this is version 2, your email is {data_without_sets["email"]}' # return a formatted string with the name from the JSON data
...
#curl -X POST http://127.0.0.1:5000/v2/hello -H "Content-Type: application/json" -d '{"name": "Rachel", "email": "rfernandez@gmail.com"}'
